...
const mutations = {
  ...
  /*get all allownce program  start*/
  GET_ALL_ALLOWNCE_PROGRAME_FIELD: (state, data) => {
    state.allowanceProgrames = data;
  },
  /*get all allownce program  emd*/
...
const actions = {
  ...
  /*Get All Allownce Program Name start*/
  GetAllAllownceProgram: ({ commit }) => {
    return http()
      .get("/admin/allowance/get")
      .then((result) => {
        commit("GET_ALL_ALLOWNCE_PROGRAME_FIELD", result.data.data);
      })
      .catch((err) => {
        console.log(err);
      });
  },
  /*Get All Allownce Program Name end*/
  /*Get All Additional Field start*/
  ...
  StoreAllowanceProgram: ({ commit }, data) => {
    return http()
      .post("/admin/allowance/insert", data)
      .then((result) => {
  ...
  UpdateAllowanceProgram: ({ commit }, { id, data }) => {
    return http()
      .post(`/admin/allowance/update/${id}`, data)
      .then((result) => {
  ...
  updateAdditionalField: ({ commit }, { id, data }) => {
    return http()
      .post(`/admin/allowance/allowance-additional-field/update`, data)
      .then((result) => {
        // commit('UPDATE_ALLOWANCE_PROGRAM', result);
        // console.log(result);
        return result;
  ...
  DeleteGender: ({ commit }, data) => {
    return http()
      .post("/admin/allowance/gender_delete", data)
      .then((result) => {
  ...
  DeleteDisableClass: ({ commit }, id) => {
    return http()
      .post(`/admin/allowance/disable_delete/${id}`)
      .then((result) => {
