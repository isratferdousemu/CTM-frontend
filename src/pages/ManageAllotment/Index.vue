                  ...
                  <v-row>
                    ...
                    <v-col lg="6" md="6" cols="12">
                      <v-autocomplete outlined clearable
                        :label="$t('container.system_config.demo_graphic.district.district')" :items="districts"
                        item-text="name_en" item-value="id">
              ...
              <v-card-text>
                ...
                <v-row class="ma-0  white round-border d-flex justify-space-between align-center" justify="center"
                  ...
                  <v-col cols="12">
                    ...
                    <v-data-table :headers="headers" :items="allotments"  :loading="loading"
                        item-key="id"
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        {
          text: this.$t(
            "container.manage_allotment.program"
          ),
          value: "",
        },
        {
        ...
        },
        {
          ...
          {
          text: this.$t(
            "container.manage_allotment.regular_payment"
          ),
          value: "",
        },
             {
          text: this.$t(
            "container.manage_allotment.additional"
          ),
          value: "",
        },
             {
          text: this.$t(
            "container.manage_allotment.post"
          ),
          value: "",
        },
             {
        ...
        { text: this.$t("container.list.action"), value: "actions", width: '15%', align: "center", },
  ...
  methods: {
    ...
    updateHeaderTitle() {
      const title = this.$t(
        "container.manage_allotment.list"
      );
