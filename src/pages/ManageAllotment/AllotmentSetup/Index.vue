              ...
              <v-card-text>
                ...
                >
                  <div class="d-flex justify-sm-end flex-wrap">
                    <v-text-field
                      @keyup.native="GetAllotmentSetup"
                      outlined
                      dense
                      v-model="search"
                  ...
                  <v-col lg="6" md="6" cols="12">
                    ...
                    >
                      <v-autocomplete
                        outlined
                        clearable
                        v-model="data.area_type"
                        :items="locationTypes"
                        @input="onChangeAreaType($event)"
                        item-text="value_en"
                        item-value="id"
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      this.allotmentAreas = [];
      (this.data.area_type = null), (this.data.value = null);
      this.errors = {};
    },
    ...
    updateHeaderTitle() {
      const title = this.$t("container.manage_allotment.allotment_setup_list");
