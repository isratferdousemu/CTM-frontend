                                ...
                                <ValidationObserver ref="form" v-slot="{ invalid }">
                                    <v-form v-on:submit.prevent="updateDevice">
                                            ...
                                            <v-row wrap>
                                                <v-col cols="12" sm="6" lg="6">
                                                    <ValidationProvider name="User Id" vid="user_id" rules="required"
                                                        v-slot="{ errors }">
                                                        <v-select :items="users" item-text="username"
                                                            item-value="user_id" :label="$t('container.system_config.device.user_id')
                                        " menu-props="auto" hide-details persistent-hint outlined
                                                            :error="errors[0] ? true : false"
                                                            :error-messages="errors[0]" required readonly
                                                            v-model="editDevice.user_id"></v-select>
                                                    </ValidationProvider>
                                                </v-col>
                                                ...
                                                <v-col cols="12" sm="6" lg="6">
                                                    <ValidationProvider name="Full Name" vid="name" rules="required"
                                                        v-slot="{ errors }">
                                                        <v-text-field type="text" v-model="editDevice.name" :label="$t('container.system_config.device.full_name')
                                        ...
                                        " menu-props="auto" hide-details persistent-hint outlined
                                                            ...
                                                            v-model="editDevice.device_type"></v-select>
                                                    </ValidationProvider>
                                                </v-col>
                                                ...
                                                <v-col cols="12" sm="6" lg="6">
                                                    <ValidationProvider name="Device Id" vid="device_id"
                                                        rules="required" v-slot="{ errors }">
                                                        <v-text-field type="text" v-model="editDevice.device_id" :label="$t('container.system_config.device.unique_id')
                                        " persistent-hint outlined :error="errors[0] ? true : false" :error-messages="errors[0]"
                            ...
                            ></v-text-field>
                                                ...
                                                <v-col cols="12" sm="6" lg="6">
                                                    <ValidationProvider name="Purpose Use" vid="purpose_use"
                                                        rules="required" v-slot="{ errors }">
                                                        <v-text-field type="text" v-model="editDevice.purpose_use"
                                                            label="Enter Purpose of Use" persistent-hint outlined
                                                            :error="errors[0] ? true : false"
                                        ...
                                        $t("container.list.back") }}
                                            ...
                                            <v-btn flat color="success" type="submit" class="custom-btn mr-2"
                                                :disabled="invalid">{{ $t("container.list.update") }}
                                            </v-btn>
                                        </v-row>
                                    </v-form>
                                </ValidationObserver>
