    ...
    methods: {
        ...
        submitForm() {
           ...
           ;
            ...
            this.$axios
                .post("admin/training/circulars", formData, {
                    headers: {
...
<template>
    ...
    : 'Please enter No of Participant (Open)') : ''"></v-text-field>
                                        ...
                                        " persistent-hint outlined :error="errors[0] ? true : false" :error-messages="errors[0] ? (language == 'bn' ? 'অনুগ্রহ পূর্বক সর্বাধিক ১০ অক্ষর সমেত ক্লাসের সময়কাল (ঘন্টা/দিন)  প্রদান করুন '
