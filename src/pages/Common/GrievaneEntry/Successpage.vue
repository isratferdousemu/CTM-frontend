        ...
        <v-card>
          <v-card-text class="mt-10 text-center">
            <p style="font-size: 15px" class="mt-5">
              {{ $t('container.application_selection.application.successfull') }} <span style="font-size:20px;">:{{ trackingNo }} </span>
...
export default {
  components: {
    ...
    computed: {
        ...
        trackingNo() {
            return this.$store.state.ApplicationSelection.trackingNo;
        },
    },
    methods: {
        generatePDF() {
