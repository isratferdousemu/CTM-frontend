    ...
    <div id="application">
        ...
        ">
                                ...
                                ">*</span></label>
                                                ...
                                                <div class="d-inline d-flex justify-end">
                                                    <v-btn @click="resetForm()" elevation="2" class="btn mr-2"
                                                        color="info">Resets</v-btn>
                                                    <!-- :disabled="invalid" -->
                                                    <v-btn type="submit" flat color="primary" :disabled="invalid"
