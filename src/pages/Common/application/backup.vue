                                            ...
                                            <V-row>
                                                ...
                                                <v-col cols="4">
                                                    ...
                                                    <ValidationProvider name="Number" vid="verification_number"
                                                        rules="checkNumber" v-slot="{ errors }">
                                                        <label>
    ...
    $t('container.application_selection.application.signature_alert')
                                                    ...
                                                    <v-col cols="6" lg="6">
                                                        <ValidationProvider name="Gender" vid="gender" v-slot="{ errors }"
                                                            ...
                                                            <v-select v-model="data.gender_id" item-text="value_en"
                                                                item-value="id" outlined :items="genders"
                                                                :error="errors[0] ? true : false"
                                                                :error-messages="errors[0]">
                                                            </v-select>
                                                        </ValidationProvider>
                                                    ...
                                                    <v-col cols="6" lg="6">
                                                        <ValidationProvider name="Profession" vid="profession"
                                                            ...
                                                            <span style="margin-left: 4px; color: red">*</span>
                                                            <v-autocomplete v-model="data.profession" outlined clearable
                                                                :items="professionType" :error="errors[0] ? true : false"
                                                                :error-messages="errors[0]">
                                                            </v-autocomplete>
                                                        </ValidationProvider>
                                                    </v-col>
                                            ...
                                            <v-row>
                                                ...
                                                <v-col v-if="data.location_type == 2 && data.sub_location_type === 2"
                                                    ...
                                                    <ValidationProvider name="union" vid="union_id" rules="required"
                                                        ...
                                                        <span style="margin-left: 4px; color: red">*</span>
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            v-model="data.union_id" outlined @input="onChangeUnion($event)"
                                                ...
                                                <v-col v-if="data.location_type == 2 && data.sub_location_type === 1"
                                                    cols="6">
                                                    <ValidationProvider name="Pouroshava" vid="pouro_id" rules="required"
                                                        v-slot="{ errors }">
                                                        <label style="display: inline-block">{{
                                                        ...
                                                        <span style="margin-left: 4px; color: red">*</span>
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            v-model="data.pouro_id" @input="onChangePouro($event)" outlined
                                                ...
                                                <v-col v-if="data.location_type == 1" lg="6" md="6" cols="6">
                                                    <ValidationProvider name="thana" vid="district_pouro_id"
                                                        ...
                                                        <span style="margin-left: 4px; color: red">*</span>
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            v-model="data.district_pouro_id" @input="onChangeDistrictPouro"
                                                            outlined :items="district_poros" item-text="name_en"
                                                ...
                                                <v-col v-if="data.location_type == 2 && data.sub_location_type == 2" lg="6"
                                                    md="6" cols="6">
                                                ...
                                                <v-col cols="6" lg="6">
                                                    <ValidationProvider name="Post Code" vid="post_code" rules="CheckPost"
                                                        v-slot="{ errors }">
                                                        <label style="display: inline-block">{{
                                            ...
                                            <v-row>
                                                ...
                                                <v-col
                                                    ...
                                                    <ValidationProvider name="Pouroshava" vid="permanent_pouro_id"
                                                        ...
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            ...
                                                            :items="permanent_pouros" item-text="name_en" item-value="id"
                                                            :error="errors[0] ? true : false"
                                                            :error-messages="errors[0]"></v-autocomplete>
                                                    </ValidationProvider>
                                                </v-col>
                                                ...
                                                <v-col v-if="data.permanent_location_type == 3" lg="6" md="6" cols="12">
                                                    <ValidationProvider name="permanent_ward_id_city"
                                                        vid="permanent_ward_id_city" rules="required" v-slot="{ errors }">
                                                        <label style="display: inline-block">Ward
                                                        </label>
                                                        <span style="margin-left: 4px; color: red">*</span>
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            v-model="data.permanent_ward_id_city" outlined
                                                            :items="permanent_wards_city" item-text="name_en"
                                                            item-value="id" :error="errors[0] ? true : false"
                                                            :error-messages="errors[0]"></v-autocomplete>
                                                    </ValidationProvider>
                                                </v-col>
                                                <v-col v-if="data.permanent_location_type == 1" lg="6" md="6" cols="12">
                                                    <ValidationProvider name="permanent_ward_id_dist"
                                                        vid="permanent_ward_id_dist" rules="required" v-slot="{ errors }">
                                                        <label style="display: inline-block">{{
                                                            $t('container.system_config.demo_graphic.ward.ward') }}
                                                        </label>
                                                        <span style="margin-left: 4px; color: red">*</span>
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            ...
                                                            :items="permanent_wards_dist" item-text="name_en"
                                                            item-value="id" :error="errors[0] ? true : false"
                                                            :error-messages="errors[0]"></v-autocomplete>
                                                    </ValidationProvider>
                                                </v-col>
                                                <v-col
                                                    ...
                                                    <ValidationProvider name="permanent_ward_id_upazila"
                                                        ...
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            ...
                                                            :items="permanent_wards_upazila_union" item-text="name_en"
                                                            item-value="id" :error="errors[0] ? true : false"
                                                            :error-messages="errors[0]"></v-autocomplete>
                                                    </ValidationProvider>
                                                </v-col>
                                                <v-col
                                                    ...
                                                    <ValidationProvider name="permanent_ward_id_upazila"
                                                        ...
                                                        <v-autocomplete :hide-details="errors[0] ? false : true"
                                                            ...
                                                            :items="permanent_wards_upazila_pouro" item-text="name_en"
                                                            item-value="id" :error="errors[0] ? true : false"
                                                            :error-messages="errors[0]"></v-autocomplete>
                                                    </ValidationProvider>
                                                </v-col>
        ...
        ">
                            ...
                            ">*</span>
                                                ...
                                                <v-col cols="6" lg="6" v-if="data.account_type === 1">
                                                    <ValidationProvider rules="required" name="Bank name" vid="bank_name"
                                                        v-slot="{ errors }">
                                                                ...
                                                                <v-row>
                                                                    <v-col cols="10" lg="10">
                                                                        <ValidationProvider
                                                                            ...
                                                                            v-slot="{ errors }">
                                                                            <label>National Identity (NID) / Birth
                                                                                Registration Number</label>
                                                                            <span
                                                                                style="margin-left: 4px; color: red">*</span>
                                                                            <v-text-field
                                                                                v-model="data.nominee_verification_number"
                                                                                outlined @change="checkNum()" clearable
                                                                                type="text"
                                                                                :error="errors[0] ? true : false"
                                                                                :error-messages="errors[0]">
                                                                            </v-text-field>
                                  ...
                                  " class="mb-5"></v-img>
                                                        <ValidationProvider v-slot="{ errors }" name="Image"
                                                            :rules="('imageSize')" rules="imageSize" vid="image">
                                  ...
                                  " class="mb-5"></v-img>
                                                        <ValidationProvider v-slot="{ errors }" name="Signature"
                                                            rules="imageSize" vid="nominee_signature">
                            ...
                            <div class="d-inline d-flex justify-end">
                                ...
                                <!-- :disabled="invalid" -->
                                <v-btn @click="confirmDialog = true" flat color="primary" :disabled="invalid"
                                    :loading="loading" class="custom-btn-width black white--text py-2">
                                    submit
                                </v-btn>
                    ...
                    <v-dialog v-model="confirmDialog" max-width="700" max-height="500">
                        <v-card>
                            ...
                            <v-card-actions class="d-flex justify-center">
                                ...
                                <v-btn text flat color="primary" @click="submitApplication()" :loading="loading"
                                    type="submit" class="custom-btn-width success white--text py-2">
                                    {{ $t("container.list.confirm") }}
                                </v-btn>
                            </v-card-actions>
                        </v-card>
