                        ...
                        <v-card elevation="12" class="d-flex" min-height="550">
                                <v-sheet width="50%" color="#0D47A1">
                                        ...
                                        <div class="d-flex align-center justify-center white--text">
                                                Integrated Social Protection Management Information System (ISPMIS)
                                        ...
                                        <div class="d-flex align-center justify-start white--text mx-2">
                                                ...
                                                No One's ID and password is asked from the MIS admin of the Department Social Services without solving your problem.Beware of cheaters. Please do not share your password with anyone and do not save it in your browser.
                                ...
                                <v-sheet width="50%" class="d-flex align-center justify-center">
                                        ...
                                        <div class="d-flex align-center justify-center">
                                                <v-form @submit.prevent="submitData" class="ma-5">
                                                        <v-text-field label="Username" v-model="data.email" required></v-text-field>
                                                        <div v-if="errors && errors.email" v-html="errors.email" />
                                                        <v-text-field label="Password" type="password" v-model="data.password" required></v-text-field>
                                                        <div v-if="errors && errors.password" v-html="errors.password" />
                                                        <div class="d-inline d-flex justify-end">

                                                                <v-btn color="blue" :loading="loading" @click="submitData">Login</v-btn>
...
export default {
        ...
        methods: {
               async submitData() {
                      ...
                      this.loading = true ;
                     await axios.post("http://127.0.0.1:8000/api/v1/admin/login", this.data)
                                .then((response) => {
                                        this.loading = false;
