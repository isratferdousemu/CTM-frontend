                        ...
                        <v-card elevation="12" class="d-flex" min-height="550">
                                <v-sheet width="50%" color="#0D47A1">
                                        ...
                                        <div class="d-flex align-center justify-start orange--text mx-6">
                                                ...
                                                No One's ID and password is asked from the MIS admin of the Department Social Services without solving your
                                                problem.Beware of cheaters. Please do not share your password with anyone and do not save it in your
                                                browser.
                                ...
                                <v-sheet width="50%">
                                        ...
                                        <div class="d-flex flex-column align-center justify-center" style="height: 70vh;">
                                                ...
                                                <v-form @submit.prevent="submitData" class="ma-5">
                                                        ...
                                                        <div v-if="message" v-html="message" class="red--text" />
...
export default {
        ...
        methods: {
                async submitData() {
                        this.loading = true;
                        axios.post("/admin/login/otp", this.form)
                                .then((response) => {
                                        this.loading = false;
