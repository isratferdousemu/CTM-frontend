        ...
        <div class="copy-field-container">
                <div class="content">
                        <div style="width: 400px">
                                <v-text-field label="Browser Fingerprint" append-inner-icon="mdi-clipboard-outline"
                                        @click:append-inner="browserCopyToClipboard" v-model="fingerPrint"
                                        outlined></v-text-field>
                                <v-text-field label="IP Address" append-inner-icon="mdi-clipboard-outline"
                                        @click:append-inner="copyToClipboard" v-model="ipAddress" outlined></v-text-field>
