                                    ...
                                    <ValidationObserver ref="form" v-slot="{ invalid }">
                                        <form @submit.prevent="submitWard()">
                                            <v-row>
                                                ...
                                                <v-col lg="6" md="6" cols="12">
                                                    <v-select outlined clearable :label="$t('container.list.status')">
                                                    </v-select>
                                                </v-col>
                                                ...
                                                <v-col lg="6" md="6" cols="12">
                                                    <v-select outlined clearable
                                                        :label="$t('container.beneficiary_management.beneficiary_list.search_by')">
                                                    </v-select>
                                                </v-col>
                            ...
                            <v-expansion-panel class="ma-2">
                                ...
                                <v-expansion-panel-content class="elevation-0 transparent mt-10">
                                    <v-row>
                                        ...
                                        <v-col lg="6" md="6" cols="12">
                                            <v-text-field outlined clearable
                                                :label="$t('container.beneficiary_management.beneficiary_list.account_no')">
