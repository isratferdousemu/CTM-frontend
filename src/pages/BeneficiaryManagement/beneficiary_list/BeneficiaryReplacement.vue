          ...
          <v-expansion-panel-content>
              <v-row class="mt-10">
                                ...
                                <v-col lg="6" md="6" cols="12">
                                    ...
                                    <v-select outlined menu-props="top" clearable
                                        :label="$t('container.beneficiary_management.beneficiary_list.replacement_cause')">
                                    </v-select>
                                </v-col>
                                ...
                                <v-col lg="6" md="6" cols="12">
                                    <v-file-input outlined show-size counter prepend-inner-icon="mdi mdi-file-account-outline"
                                        accept="image/*" prepend-icon=""></v-file-input>
              ...
              <v-card-title class="justify-center" tag="div">
                 <h3 class="text-uppercase pt-3">
                      {{ $t("container.beneficiary_management.beneficiary_list.beneficiary_replacement_list") }}
                    </h3>
              </v-card-title>
                <v-card-text>
