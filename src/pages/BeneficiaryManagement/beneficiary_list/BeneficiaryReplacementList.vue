<template>
                ...
                <v-expansion-panel class="ma-2">
                  <v-expansion-panel-header color="#8C9EFF">
                    <h3 class="white--text">
                      {{
                        $t(
                          "container.beneficiary_management.beneficiary_list.list_replacement"
                        )
                      }}
                    </h3>
              ...
              >
                <v-card-title class="justify-center" tag="div">
                  <h3 class="text-uppercase pt-3">
                    {{
                      $t("container.beneficiary_management.beneficiary_list.list_replacement")
                    }}
                  </h3>
                </v-card-title>
                <v-card-text>
  ...
  export default {
    ...
    title: "CTM - Beneficiary (Replacement Log) List",
    data() {
      return {
        data: {
          program_id: null,
