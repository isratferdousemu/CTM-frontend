            ...
            <v-col cols="12">
                <v-card>
                    <v-card-text class="mt-5">
                        <v-row>
                            <v-col cols="12">
                                <v-textarea  :label="$t('container.beneficiary_management.beneficiary_list.beneficiary_summary')" outlined clearable>
                            ...
                            <v-col lg="6" md="6" cols="12">
                                <v-menu ref="menu" v-model="menu" :close-on-content-click="false" :return-value.sync="date"
                                    ...
                                    <template v-slot:activator="{ on, attrs }">
                                        <v-text-field v-model="date" label="Activation Date" prepend-inner-icon="mdi-calendar"
                            ...
                            <v-col cols="12">
                                <v-textarea :label= "$t('container.list.reason')"  outlined clearable>
