              ...
              <div>
                <v-expansion-panels v-model="panel" multiple>
                  ...
                  <v-expansion-panel>
                    ...
                    <v-expansion-panel-content class="mt-5">
                      <template>
                        <ValidationProvider name="program" vid="verification_type" rules="required" v-slot="{ errors }">
                          <v-radio-group :readonly="isRadioGroupReadonly" v-model="data.verification_type" row>
                            <v-radio :label="$t('container.beneficiary_management.beneficiary_list.national_identity')"
                              value="1" v-if="isRadioGroupReadonly"></v-radio>
                            <v-radio :label="$t('container.beneficiary_management.beneficiary_list.birth_registration')"
                      ...
                      <V-row>
                        <v-col>
                          <ValidationProvider name="Number" vid="verification_number" rules="required"
                            ...
                            <label>
                              ...
                              <span v-else>{{ $t("container.beneficiary_management.beneficiary_list.nid_or_brn_no") }}
                              </span>
                            </label>
                            <span style="margin-left: 4px; color: red">*</span>
                        ...
                        <v-col>
                          <label> <label>{{ $t("container.beneficiary_management.beneficiary_list.date_of_birth") }}
                            </label> </label>
                  ...
                  <v-expansion-panel class="mt-5" v-model="panel" multiple>
                    ...
                    <v-expansion-panel-content class="mt-5">
                      <V-row>
                        ...
                        <v-col>
                          <ValidationProvider name="Number" vid="verification_number" rules="required"
                            v-slot="{ errors }">
                            <label>
                              <span> {{ $t("container.beneficiary_management.beneficiary_list.govt_private_ben_details") }}
                              </span>
                            </label>
                            <span style="margin-left: 4px; color: red">*</span>
                            <v-text-field outlined readonly v-model="data.verification_number" class="mr-2" type="number"
                      ...
                      <V-row>
                        <v-col>
                          <ValidationProvider name="Number" vid="verification_number" rules="required"
                            v-slot="{ errors }">
                            <label>
                              <span> {{ $t("container.beneficiary_management.beneficiary_list.total_no_of_family_member") }}
                              </span>
                            </label>
                            <span style="margin-left: 4px; color: red">*</span>
                            <v-text-field outlined readonly v-model="data.verification_number" class="mr-2" type="number"
                      ...
                      <V-row>
                        ...
                        <v-col md="2" lg="2" cols="12">
                          <v-checkbox disabled v-model="health_status_value.totally_disabled"
                            :label="health_status[0]"></v-checkbox>
                        </v-col>
                        <v-col md="2" lg="2" cols="12">
                          <v-checkbox disabled v-model="health_status_value.sick" :label="health_status[1]"></v-checkbox>
                        </v-col>
                        <v-col md="2" lg="2" cols="12">
                          <v-checkbox disabled v-model="health_status_value.insane"
                            :label="health_status[2]"></v-checkbox>
                        </v-col>
                        <v-col md="2" lg="2" cols="12">
                          <v-checkbox disabled v-model="health_status_value.disabled"
                            :label="health_status[3]"></v-checkbox>
                        </v-col>
                        <v-col md="2" lg="2" cols="12">
                          <v-checkbox disabled v-model="health_status_value.partially_powerless"
                      ...
                      <V-row>
                        <v-col v-for="i in 5" :key="i">
                          <v-checkbox readonly :label="health_status[i - 1]" :value="health_status[i - 1]"></v-checkbox>
                        </v-col>
                      </V-row>
                    </v-expansion-panel-content>
                  </v-expansion-panel>
                  ...
                  <v-expansion-panel class="mt-5">
                    <v-expansion-panel-header color="primary">
                      <h3 class="white--text">{{ $t("container.beneficiary_management.beneficiary_list.personal_info") }}
                      </h3>
                    </v-expansion-panel-header>
                    <v-expansion-panel-content class="mt-5">
                      <div class="pa-2 mb-4">
                        <v-row>
                          ...
                          <v-col cols="6" lg="6">
                            <ValidationProvider name="Gender" vid="gender" v-slot="{ errors }" rules="required">
                              ...
                              <v-text-field v-model="data.gender.value_en" outlined required readonly
                                :error="errors[0] ? true : false" :error-messages="errors[0]">
                              </v-text-field>
                            </ValidationProvider>
                          </v-col>
                          ...
                          <v-col cols="6" lg="6">
                            <ValidationProvider name="Identification Mark" vid="identification_mark" v-slot="{ errors }">
                              <label>{{ $t("container.beneficiary_management.beneficiary_list.identification_mark") }}
                              </label>
                  ...
                  <v-expansion-panel class="mt-4">
                    <v-expansion-panel-header color="primary">
                      <h3 class="white--text">{{ $t("container.beneficiary_management.beneficiary_list.contact_info") }}
                      </h3>
                    </v-expansion-panel-header>
                    <v-expansion-panel-content class="mt-5">
                      <v-row>
                        <v-col cols="12" class="text-center">
                          <v-chip color="success" class="text-uppercase"
                            label>{{ $t("container.beneficiary_management.beneficiary_list.present_address") }}</v-chip>
                        </v-col>
                        <!-- {{ permanent_location }}  -->
                      ...
                      <v-row>
                        <v-col cols="12" class="text-center">
                          <v-chip color="success" class="text-uppercase"
                            label>{{ $t("container.beneficiary_management.beneficiary_list.permanent_address") }}</v-chip>
                        </v-col>
                  ...
                  <v-expansion-panel class="mb-4">
                    <v-expansion-panel-header color="primary">
                      <h3 class="white--text">{{ $t("container.beneficiary_management.beneficiary_list.nominee_info") }}
                      </h3>
                    </v-expansion-panel-header>
                    <v-expansion-panel-content class="mt-5">
                      <div class="pa-2 mb-4">
                        <v-row>
                          ...
                          <v-col lg="6" md="6" cols="12" v-if="data.nominee_verification_number">
                            <v-text-field v-model="data.nominee_verification_number" outlined readonly :label="$t(
                          ...
                          <v-col lg="6" md="6" cols="12" v-if="data.nominee_nationality">
                          ...
                          <v-col lg="6" md="6" cols="12" v-if="data.nominee_relation_with_beneficiary">
                            <v-text-field v-model="data.nominee_relation_with_beneficiary" outlined readonly
                              :label="$t('container.beneficiary_management.beneficiary_list.relationship_with_beneficiary')">
                            </v-text-field>
                          </v-col>

                          <v-col lg="6" md="6" cols="12" v-if="data.nominee_address">
                            <v-text-field v-model="data.nominee_address" outlined readonly
                          ...
                          <v-col cols="6" lg="6" md="6">
                            ...
                            <v-img src="data.nomineeImageUrl" v-if="!data.nomineeImageUrl" style="
                                width: 200px;
                                height: 200px;
                                border: 1px solid #ccc;
                              " class="mb-5"></v-img>
                          ...
                          <v-col cols="6" align-self="end" lg="6">
                            ...
                            <v-img v-if="!data.nomineeImageUrl" :src="data.nomineeSignUrl" style="
                                width: 200px;
                                height: 80px;
                                border: 1px solid #ccc;
                              " class="mb-5"></v-img>
                  ...
                  <v-expansion-panel class="ma-4">
                    <v-expansion-panel-header color="primary">
                      <h3 class="white--text">{{ $t("container.beneficiary_management.beneficiary_list.for_office_use") }}
                      </h3>
                    </v-expansion-panel-header>
                    <v-expansion-panel-content class="mt-5">
                      <div class="pa-2 mb-4">
                        <v-row>
                          <v-col lg="6" md="6" cols="12" v-if="data.account_number">
                          ...
                          <v-col lg="6" md="6" cols="12" v-if="data.account_name">
                          ...
                          <v-col lg="6" md="6" cols="12" v-if="data.account_owner">
                          ...
                          <v-col lg="6" md="6" cols="12" v-if="data.account_owner">
                            <v-text-field value="10000" outlined readonly
                              :label="$t('container.beneficiary_management.beneficiary_list.monthly_honorarium_amount')">
                            </v-text-field>
                          </v-col>

                          <v-col lg="6" md="6" cols="12" v-if="data.account_owner">
                            <v-text-field value="2022-23" outlined readonly
