        ...
        <v-row>
          <v-col cols="12">
            <div class="d-block text-right">
              <v-btn v-can="'beneficiaryShifting-create'" elevation="2" class="btn my-2" color="primary" router
              ...
              <v-col cols="12">
                ...
                ">
                    <h3 class="white--text text-uppercase pt-3">
                      {{ $t("container.beneficiary_management.beneficiary_shifting.shitfing_list") }}
                    </h3>
                  </v-card-title>
                  <v-card-text>
