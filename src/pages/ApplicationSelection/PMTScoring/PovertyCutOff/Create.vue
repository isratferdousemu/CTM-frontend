                                            ...
                                            <div class="d-flex justify-md-end flex-wrap">
                                                ...
                                                <ValidationProvider v-slot="{ errors }" name="Financial Year"
                                                    ...
                                                    <v-autocomplete class="mr-5" v-model="data.financial_year_id"
                                                        :items="financial_years" label="Financial Year" outlined clearable
                                                ...
                                                <ValidationProvider v-slot="{ errors }" name="type" vid="type"
                                                    ...
                                                    <v-select @input="onChangeFilter()" class="mr-5" v-model="data.type"
                                                        :items="location_types" label="Location Type" outlined clearable
                                                        dense item-text="name_en" item-value="id"
                                                        :error="errors[0] ? true : false"
                                                        :error-messages="errors[0]"></v-select>
                                                </ValidationProvider>
                                                <div v-if="data.type === 0">
                                                    <ValidationProvider v-slot="{ errors }" name="Score" vid="score"
                                                        rules="required">
                                                        <v-text-field outlined dense clearable v-model="data.score"
                                                            class="my-sm-0 my-3 mx-0v -input--horizontal " flat
