  ...
  <div id="division">
    <v-row class="mx-5 mt-4">
      ...
      <v-dialog v-model="dialogAdd" width="650">
        <v-card style="justify-content: center; text-align: center">
          <v-card-title class="font-weight-bold justify-center">
            {{ $t("container.application_selection.poverty_cut_off.add_new") }}
          </v-card-title>
          <v-divider></v-divider>
      ...
      <v-dialog v-model="dialogEdit" width="650">
        <v-card style="justify-content: center; text-align: center">
          <v-card-title class="font-weight-bold justify-center">
            {{ $t("container.application_selection.poverty_cut_off.edit") }}
          </v-card-title>
          <v-divider></v-divider>
              ...
              <form @submit.prevent="updateCuttOff()">
                ...
                >
                  <v-text-field
                    ...
                    :label="$t('container.application_selection.poverty_cut_off.name_en')"
                    required
                    :error="errors[0] ? true : false"
                    :error-messages="errors[0]"
                  ></v-text-field>
                ...
                >
                  <v-text-field
                    ...
                    type="text"
                    v-model="data.score"
                    :label="$t('container.application_selection.poverty_cut_off.score')"
                    required
                    :error="errors[0] ? true : false"
                    :error-messages="errors[0]"
                  ></v-text-field>
        ...
        <v-card style="justify-content: center; text-align: center">
          ...
          <v-card-text>
            <div class="subtitle-1 font-weight-medium mt-5">
              {{
                $t(
                  "container.application_selection.poverty_cut_off.delete_alert"
                )
              }}
            </div>
          </v-card-text>
