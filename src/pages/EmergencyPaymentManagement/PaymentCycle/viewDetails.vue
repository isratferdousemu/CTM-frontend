            ...
            <template>
              <v-simple-table dense class="table-bordered table-responsive elevation-1" style="padding: 2% 0% 2% 0%;">
                <template v-slot:default>
                  ...
                  <tbody>
                      <tr style="padding-buttom:2%" v-for="(item, index) in setViewData.payment_cycle_details" :key="index">
                        <!-- <td>{{ setViewData?.payment_cycle_details?.beneficiary?.permanent_district_id}}</td> -->
                        <td>{{ item.beneficiary.permanent_district_id }}</td>
                        <td>{{ item.beneficiary.permanent_upazila_id }}</td>
                        <td>{{ item.beneficiary.permanent_upazila_id }}</td>
                        <td>{{ item.beneficiary.program.name_en }}</td>
                        <td>{{ item.payroll_payment_cycle_id }}</td>
                        <td>{{ setViewData.name_en }}</td>
                        <td>{{ setViewData.name_en }}</td>
                        <td>{{ setViewData.total_beneficiaries }}</td>
                        <td>{{ setViewData.sub_total_amount }}</td>
                        <td>{{ item.charge }}</td>
                        <td>{{ item.amount }}</td>
