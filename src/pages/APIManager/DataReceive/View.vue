                            ...
                            <v-row class="my-custom-row ma-5">
                                ...
                                <v-col cols="12" sm="9" lg="9" xs="9" md="9">
                                    ...
                                    <span class="ml-2">
                                        ...
                                        <v-icon v-if="data?.api_key" class="ml-3" @click="toggleApiKeyVisibility()">
                                ...
                                <v-col cols="12" sm="9" lg="9" xs="9" md="12">
                                    <b>:</b>
