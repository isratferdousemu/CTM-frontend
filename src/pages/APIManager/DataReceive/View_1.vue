...
<template>
    <div id="data-receiver-view">
        <v-row class="mx-5 mt-5">
            <v-col cols="12" lg="12" md="12" sm="12" xs="12">
                <v-row wrap>
                    <v-col cols="12" lg="12" md="12" sm="6" xs="12">
                        <v-card>
                                ...
                                <v-row>
                                    <v-col cols="12" lg="12" md="12" sm="12" xs="12">
                                        <v-row class="my-custom-row ma-5">
                                            ...
                                            <v-col cols="9" sm="9" lg="9" xs="9" md="3">
                                                <b>:</b> <span class="ml-2">{{
                                            ...
                                            <v-col cols="9" sm="9" lg="9" xs="9" md="12">
                                                <b>:</b>
                                        ...
                                        <v-row>
                                            <v-col cols="12" sm="12" lg="12" xs="12" md="12"> <v-card-title
                                                    v-if="data.api_list" class="justify-center black--text">
                                                    <h5 class="mt-5">
