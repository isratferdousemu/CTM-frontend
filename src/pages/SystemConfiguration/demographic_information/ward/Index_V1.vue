    ...
    <div id="thana">
        <v-row class="mx-5 mt-4">
                                ...
                                <v-row class="ma-0 pa-3 white round-border d-flex justify-space-between align-center"
                                    ...
                                    <div class="d-flex justify-sm-end flex-wrap">
                                        <v-text-field @keyup.native="GetWard" outlined dense v-model="search"
                                            ...
                                            flat variant="outlined" :label="$t('container.system_config.demo_graphic.ward.search')
                                    ...
                                    <v-col cols="12">
                                        <v-data-table :loading="loading" item-key="id" :headers="headers" :items="wards"
                                            ...
                                            <template v-slot:item.division="{ item }">
                                                ...
                                                <span v-if="item?.location_type.id == '2' || item?.location_type.id == '3'">
                                                ...
                                                <v-tooltip top>
                                                    <template v-slot:activator="{ on }">
                                                        <v-btn v-can="'update-post'" fab x-small v-on="on" color="success"
                                                            elevation="0" @click="editWard(item)">
                        ...
                        <ValidationObserver ref="formAdd" v-slot="{ invalid }">
                            <form @submit.prevent="submitWard()">
                                <v-row>
                                    ...
                                    <v-col v-if="data.location_type == 2"  cols="12">
                                        <ValidationProvider name="Upazila" vid="thana_id" rules="required"
                                            ...
                                            <v-autocomplete :hide-details="errors[0] ? false : true" v-model="data.thana_id"
                                                outlined :label="$t('container.system_config.demo_graphic.ward.upazila')
                                    ...
                                    <v-col v-if="data.sub_location_type == 2 && data.location_type == 2"  cols="12">
                                    ...
                                    <v-col lg="12" md="12" cols="12">
                                        <ValidationProvider name="Code" vid="code" rules="codeRules||required" v-slot="{ errors }">
                                            <v-text-field :hide-details="errors[0] ? false : true" outlined type="text"
                                                v-model="data.code" :label="$t('container.system_config.demo_graphic.ward.code')
            ...
            <v-dialog v-model="dialogEdit" width="650">
                <v-card style="justify-content: center; text-align: center">
                    <v-card-title class="font-weight-bold justify-center">
                        {{ $t("container.system_config.demo_graphic.ward.edit") }}{{ errors }}
                    </v-card-title>
                    <v-divider></v-divider>
                    <v-card-text class="mt-7">
                        <v-row> </v-row>
