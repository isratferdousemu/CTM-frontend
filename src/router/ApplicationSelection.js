const ApplicationSelectionRoutes = [
...

  {
    ...
    component: () =>
      import('../pages/ApplicationSelection/Dashboard/Index.vue'),
  },
  {
    ...
    component: () =>
      import('../pages/ApplicationSelection/application_list/Index.vue'),
  },
  {
    ...
    component: () =>
      import(
        '../pages/ApplicationSelection/application_list/application_view.vue'
      ),
  },

  {
    ...
    component: () =>
      import(
        '../pages/ApplicationSelection/PMTScoring/PovertyCutOff/Create.vue'
      ),
  },
  {
    ...
    component: () =>
      import('../pages/ApplicationSelection/PMTScoring/PovertyCutOff/Edit.vue'),
  },
  {
    ...
    component: () =>
      import(
        '../pages/ApplicationSelection/PMTScoring/PovertyCutOff/Index.vue'
      ),
  },
  {
    ...
    component: () =>
      import(
        '../pages/ApplicationSelection/PMTScoring/DistrictFixedEffect/Index.vue'
      ),
  },
  {
    ...
    component: () =>
      import('../pages/ApplicationSelection/PMTScoring/Variable/Index_v1.vue'),
  },
  {
    ...
    component: () =>
      import('../pages/ApplicationSelection/PMTScoring/SubVariable/Index.vue'),
  },
  {
    ...
    component: () =>
      import('../pages/ApplicationSelection/MobileOperator/Index.vue'),
  },
];
